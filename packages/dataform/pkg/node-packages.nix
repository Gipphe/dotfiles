...
in
{
  "@dataform/cli" = nodeEnv.buildNodePackage {
    name = "_at_dataform_slash_cli";
    packageName = "@dataform/cli";
    version = "3.0.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@dataform/cli/-/cli-3.0.0.tgz";
      sha512 = "3oifMUS49tR9Qstmstmm+z2fVN3h3gA0pkFpyAbdHlT2E8gqnCnCBXlvPzY/JCnd/BzavtE3757FvyzIN9QjIA==";
    };
    dependencies = [
