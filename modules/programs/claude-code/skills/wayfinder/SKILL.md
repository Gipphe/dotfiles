...
The issue tracker should have been provided to you. If not, tell the user to run `/issue-tracker` to set it up. Consult the tracker doc's "Wayfinding operations" section for how _this_ repo expresses them.
